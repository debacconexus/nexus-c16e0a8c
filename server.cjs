...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Professional Learning & Development Nexus for Special Education Inclusive Classrooms";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Professional Development Cohort";
process.env.TABLE_NAME = process.env.TABLE_NAME || "professional_development_cohort_records";
'use strict';
